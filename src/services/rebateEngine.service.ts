...
export const DEFAULT_REBATE_SCHEMES = [
  ...
  },
  {
    ...
    is_loan: false,
    requires_confirmation: true,
    eligibility_text: "Optional Solar Victoria interest-free loan — deducted from Final Payable like other rebates.",
    explanation: "Up to $1,400 interest-free loan. Deducted from the quote final price.",
    sort_order: 110,
    active: true,
  },
  {
