...
class UserController {
    ...
    try {
      ...
      files: file,
      entityId: user.id,
      deleteOldPaths: user.profile_image ? [user.profile_image] : [],
      allowedTypes: [
      ],
      maxSizeMB: 5,
    });
      ...
      return ReS(res, SUCCESS_CODE, "Profile image updated successfully", {profile_image:uploaded});
    } catch (error) {
