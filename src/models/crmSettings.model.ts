...
const CrmSettingsSchema = new Schema(
  {
    ...
    letter_address_id: { type: String, default: "" },
    joining_address_id: { type: String, default: "" },
    offer_address_id: { type: String, default: "" },
    appointment_address_id: { type: String, default: "" },
